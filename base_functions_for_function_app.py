...
# O3_MINI_ENDPOINT2 = os.environ.get("O3_MINI_ENDPOINT2")
# O3_MINI_KEY = os.environ.get("O3_MINI_KEY")
...
def call_gpt4_api(messages, model="gpt-4o-mini"):
    ...
    if (
        ...
        or model == "gemini-2.0-flash-001"
    ):
        return call_google_ai_api(messages, model)
    # if model == "o3-mini":
    #     return call_o3_mini(messages)
    ...
    if model == "gpt-4o-mini":
        ...
        endpoint = O3_MINI_ENDPOINT
        auth_key = O3_MINI_AZURE_FOUNDRY_KEY

        # endpoint = O3_MINI_ENDPOINT2
        # auth_key = O3_MINI_KEY
        messages[0]["role"] = "developer"
        payload = {
            "messages": messages,
            # "temperature": 1.2,
